...
- Dedicated sync key material stored inside the encrypted vault, with Inspector create/rotate lifecycle controls, recovery drill, and passphrase-wrapped bootstrap metadata in new packets for recovery/first import.
- Device identity.

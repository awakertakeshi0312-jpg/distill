...
- Dedicated sync key material stored inside the encrypted vault, with passphrase-wrapped bootstrap metadata in new packets for recovery/first import.
- Device identity.

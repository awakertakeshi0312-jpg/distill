...
- Desktop white-screen prevention: Tauri desktop no longer registers the browser Service Worker, unregisters old desktop Service Workers when possible, and performs a one-time native cleanup of the `EBWebView` cache before startup

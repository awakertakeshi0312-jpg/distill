...
- Dedicated sync key material stored in encrypted sync metadata, Inspector create/rotate lifecycle controls, single-vault and A/B multi-device recovery drills, and passphrase-wrapped into new packets for first import/recovery

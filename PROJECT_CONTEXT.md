...
- Current completion estimate: 51% overall; this phase advanced +2pt in this pass.
- Implemented in this pass: assisted sync-folder preview that auto-opens exactly one unambiguous safe packet after safety scan.
- Sync-folder packet statuses: ready, risk review, stale, blocked, checkpoint risk, invalid. Recommended preview never auto-applies.
...
- Primary docs: `docs/project_context.md`, `docs/roadmap.md`, `docs/sync_design.md`, `docs/release_notes_0.1.20.md`.
## 役割

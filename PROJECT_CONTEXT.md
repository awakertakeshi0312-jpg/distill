...
- Implemented in this pass: The thought capture lane now starts empty instead of prefilled with an example sentence, while keeping the instructional placeholder visible.

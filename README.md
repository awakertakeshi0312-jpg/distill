...
- Frontend/domain tests: 53 passed.
...
```text
src-tauri/target/release/bundle/nsis/Distill_0.1.29_x64-setup.exe
```

Installer SHA256:

```text
F5F385F0C4A2180903C19B14E52DC29EFF4305385331638915E45929881C4D52
```

Signed auto-update flow:

1. Build a signed release with `npm run release:windows`.
2. Upload `release/Distill_0.1.29_x64-setup.exe`, `.sig`, and `latest.json` to the configured release endpoint.
